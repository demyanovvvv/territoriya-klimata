        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto ">
                ...
                <li class="main_menu__nav-item nav-item">
                    <a class="main_menu__nav-item-link nav-link" href="/uslugi/"><img class="main_menu__nav-item-icon" src="<?php bloginfo('template_directory'); ?>/images/wrench.svg" alt="Услуги"> Услуги</a>
                </li>
                <li class="main_menu__nav-item nav-item">
                    <a class="nav-link" href="/kak-kupit/"><img class="main_menu__nav-item-icon" src="<?php bloginfo('template_directory'); ?>/images/cart.svg" alt="Как купить?"> Как купить?</a>
                </li>
            </ul>
            <form class="form-inline main_menu__search my-2 my-lg-0" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                <div class="input-group">
                    <input type="text" class="form-control main_menu__search-input" placeholder="Что найти?" aria-label="Найти..." value="<?php echo get_search_query(); ?>" name="s">
                    <span class="input-group-btn">
                              <button class="btn main_menu__search-button" type="submit"><img class="main_menu__search-button-icon" src="<?php bloginfo('template_directory'); ?>/images/magnify.svg" alt=""></button>
                            </span>
                </div>
            </form>
        </div>
